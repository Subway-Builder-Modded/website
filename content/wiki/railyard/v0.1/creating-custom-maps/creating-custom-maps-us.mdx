...
:::tip
For more optional features that can be included in `config.json`, check the [optional features page](/wiki/railyard/creating-custom-maps/custom-map-optional-features).
:::
