...
Custom URL:   Required if using Custom URL. The full URL to your self-hosted update.json file. The file must follow
              ...
              https://subwaybuildermodded.com/wiki/railyard/latest/developers/publishing-map-packs#custom-update-schema-template.
