...
On the wiki's [issues page](https://github.com/Subway-Builder-Modded/website/issues), you can open an issue with the prefix [New Map] followed by the name of your map. Include a link to the download of your map, **as well as the population for your map to be displayed on the wiki**. Additionally, you can post the map in the #map-sharing channel of the [Subway Builder Discord](https://discord.gg/jrNQpbytUQ).
