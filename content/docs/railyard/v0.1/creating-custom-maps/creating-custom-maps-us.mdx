...
<img width="1000" alt="image" src="/images/docs/railyard/creating-custom-maps/legacy-patcher.png" />
...
<img width="1000" alt="image" src="/images/docs/railyard/creating-custom-maps/map-patcher-config.png" />
...
:::tip
For more optional features that can be included in `config.json`, check the [optional features page](/railyard/docs/v0.1/creating-custom-maps/custom-map-optional-features).
:::
