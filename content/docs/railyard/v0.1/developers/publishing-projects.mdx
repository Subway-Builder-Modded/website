...
For maps, use the ZIP that you made using the [custom map creation guide](/docs/railyard/creating-custom-maps/creating-custom-maps-us).
...
If you want to host multiple projects within a single repository, follow the [using custom URL guide](/docs/railyard/v0.1/developers/using-custom-url) for further instructions. This will teach you how to set up your custom Update JSON for Railyard to pull from.
...
Railyard requires all map makers to submit the source and quality of their data. This is then used to categorize the data for users looking to download maps. For more detailed information on the specifications of data quality, see [**Data Quality**](/docs/railyard/v0.1/developers/data-quality).
